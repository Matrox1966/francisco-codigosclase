...
def grafic(numeropersonas):   
    dades = numeropersonas # Valors de les variables
    ...
    ax1.set_ylabel('Personas') # Llegenda de eix Y.
    ...
    ########################################## GUARDAR LA FIGURA #########################################################################
    plt.savefig('contador.png', bbox_inches='tight')
    plt.close(fig)
